...
function getPlotHeightForPanel(panelHeight) {
  return Math.max(
    0,
    getCanvasHeightForPanel(panelHeight) - PLOT_PADDING.top - PLOT_PADDING.bottom
  )
}
...
const SignalViewer = ({ edfData, onBack }) => {
  ...
  }, [edfData, selectedChannels, channelById, channelFormats, channelStripHeights, channelYZoom, binaryMaskChannels, getChannelFormat, getBinaryMaskOverlayTargets, viewStart, viewEnd, totalDuration, canvasSize.width, canvasSize.height])
                ...
                <div className="signal-canvas-scroll-area">
                  <div className="signal-canvas-wrap" ref={canvasWrapRef}>
                    <canvas
                      ...
                      title="Scroll on the plot to zoom time. Use the left strip to reorder channels (drag) or zoom Y-axis (scroll)."
                    />
            ...
            <div className="view-presets-panel">
              <div className="view-presets-header">
                ...
                <p className="view-presets-hint">
                  Save all viewer settings to IndexedDB: channel order, channels, depiction formats, binary mask
                  overlays, time zoom, panel height, channel strip heights, Y-axis zoom, and active tab.
                </p>
              </div>
